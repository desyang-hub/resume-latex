...
%======================================================================
\begin{abstract}
深入掌握现代 C++（C++11/14）语言特性，包括智能指针、模板元编程、多线程与内存管理；
熟练使用 Linux 开发环境，精通 Git 版本控制、Make/CMake 构建系统及调试工具链（gdb, strace, perf）；
牢固掌握操作系统原理、计算机网络、数据库基础及经典数据结构与算法，能够高效设计并实现高性能、高可靠性的系统级软件。
\end{abstract}
